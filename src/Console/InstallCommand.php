...
{
    use InstallsApiStack, InstallsBladeStack, InstallSimpleBladeStack, InstallsInertiaStacks;
     ...
     * @var string
     */
    protected $signature = 'breeze:install {stack=simple-blade : The development stack that should be installed (blade,simple-blade,react,vue,api)}
    ...
    public function handle()
    {
        ...
        } elseif ($this->argument('stack') === 'simple-blade') {
            return $this->installSimpleBladeStack();
        }

        $this->components->error('Invalid stack. Supported stacks are [blade], [simple-blade], [react], [vue], and [api].');
